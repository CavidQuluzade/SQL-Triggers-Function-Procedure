...
('Group3', 5, '2022-01-27', '2025-01-01'),
('Group4', 2, '2021-02-14', '2023-01-01')
SELECT * FROM Groups
INSERT INTO Students
VALUES
('Name1', 'Surname1', 'name1sname1@code.edu.az', default, '2006-01-01', 85.6, 1),
('Name2', 'Surname2', 'name2sname2@code.edu.az', default, '2006-03-01', 95.59, 1)
SELECT * FROM Students
INSERT INTO Students
VALUES
('Name3', 'Surname3', 'name3sname3@code.edu.az', default, '2000-02-01', 85, 1)
INSERT INTO Students
VALUES
('Name4', 'Surname5', 'name4sname4@code.edu.az', default, '2006-01-01', 85.67, 4),
('Name5', 'Surname5', 'name5sname5@code.edu.az', default, '2006-03-01', 95, 4)
INSERT INTO Students
VALUES
('Name6', 'Surname6', 'name6sname6@code.edu.az', default, '2012-02-01', 85, 4)
